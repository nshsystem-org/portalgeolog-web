...
export default function FormasPagamentoPage() {
  ...
  const canCreate = hasPageAction(profile, "formas-pagamento", "create");
  const canDelete =
    hasPageAction(profile, "formas-pagamento", "delete") ||
    hasPageAction(profile, "formas-pagamento", "sensitive");
                  ...
                  <button
                    ...
                    title={
                      item.ativo
                        ...
                        : "Desarquivar Forma de Pagamento"
                    }
