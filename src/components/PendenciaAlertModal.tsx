...
export function shouldShowPendenciaAlert(
  data: PendenciaAlertData | null,
): boolean {
            ...
            <div className="relative bg-[#001c3a] p-8 text-white overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 text-sm font-bold uppercase tracking-wider">
                  {primeiroNome
                    ? `${primeiroNome}, você precisa revisar`
              ...
              <div className="space-y-3">
                {categorias.map((cat) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`p-3 ${cat.iconBg} rounded-xl flex-shrink-0 group-hover:scale-110 transition-transform`}
                      >
                      ...
                      <div className="flex flex-col items-end pl-4 border-l border-slate-200/60 ml-auto">
                        <div
                          className={`text-3xl font-black ${cat.iconColor} tabular-nums leading-none`}
                        >
                          {cat.count}
                        </div>
