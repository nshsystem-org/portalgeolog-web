      ...
      {open && (
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
            <h3 className="font-black text-xl text-slate-800">Motoristas</h3>
          ...
          <div className="max-h-[520px] overflow-y-auto py-2 space-y-1">
            {filtered.length === 0 ? (
              <div className="py-10 text-center text-slate-400">
                ...
                <p className="text-base">Nenhuma movimentação de motorista</p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="leading-snug">
                        <span
                          className={`text-base font-bold ${!notification.read ? "text-slate-900" : "text-slate-400"}`}
                        >
