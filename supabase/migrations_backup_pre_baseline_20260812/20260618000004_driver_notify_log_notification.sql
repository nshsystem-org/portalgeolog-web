-- =============================================================================
-- Migration: driver_notify_log_notification
-- Data: 2026-06-18
-- =============================================================================
-- Adiciona o tipo "driver_notify" ao trigger handle_os_log_notification para
-- que o sino de notificações (app_notifications) mostre quando uma mensagem
-- WhatsApp foi enviada com sucesso ao motorista, visível para todos os
-- usuários internos.
--
-- Fluxo:
--   1. Frontend envia mensagem via /api/whatsapp
--   2. Em caso de sucesso, insere um log em os_logs com type = 'driver_notify'
--      e metadata { motorista, cycle_index, message_id }
--   3. O trigger AFTER INSERT gera a notificação no sino automaticamente
-- =============================================================================
