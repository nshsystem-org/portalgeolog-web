-- =============================================================================
-- Migration: fix_driver_notify_notification_message
-- Data: 2026-06-28
-- =============================================================================
-- Corrige a mensagem da notificação gerada quando um log 'driver_notify' é
-- inserido em os_logs. A mensagem anterior mostrava o nome do motorista no lugar
-- do operador, pois usava NEW.actor_name (que é o operador) como nome do motorista.
-- Agora a mensagem informa corretamente:
