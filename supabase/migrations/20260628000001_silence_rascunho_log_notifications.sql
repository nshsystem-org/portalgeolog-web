-- =============================================================================
-- Migration: silence_rascunho_log_notifications
-- Data: 2026-06-28
-- =============================================================================
-- Corrige regressão: a migration 20260628000000_fix_driver_notify_notification_message
-- redefiniu handle_os_log_notification sem o filtro de rascunho que existia em
-- 20260626000001_rascunho_silencioso. Isso fez com que editar/salvar um rascunho
-- gerasse notificações no sino (ex: "atualizou um atendimento").
--
-- Esta migration adiciona o filtro de volta: se a OS for do tipo 'rascunho',
-- a trigger retorna NEW sem gerar nenhuma notificação.
-- =============================================================================
